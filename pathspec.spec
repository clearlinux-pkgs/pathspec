...
Source0  : https://files.pythonhosted.org/packages/93/9c/4bb0a33b0ec07d2076f0b3d7c6aae4dad0a99f9a7a14f7f7ff6f4ed7fa38/pathspec-0.8.0.tar.gz
...
%prep
%setup -q -n pathspec-0.8.0
cd %{_builddir}/pathspec-0.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586446789
...
cp %{_builddir}/pathspec-0.8.0/LICENSE %{buildroot}/usr/share/package-licenses/pathspec/9744cedce099f727b327cd9913a1fdc58a7f5599
